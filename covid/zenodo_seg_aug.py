...
def main():
    ...
    print('zenodo augmneted data: 4-fold cross-validation')
    
    # Supervised learning data for training and validation
    data_dir = '/home/marafath/scratch/zenodo/aug_data'
    
    train_images = sorted(glob.glob(os.path.join(data_dir, "image_*")))
    train_labels = sorted(glob.glob(os.path.join(data_dir, "label_*")))
    data_dicts = [
    ...
    for i in range(0,4):
        if i == 0:
            train_files, val_files = data_dicts[0:60], data_dicts[60:80]
        elif i == 1:
            train_files = data_dicts[0:40] + data_dicts[60:80]
            val_files = data_dicts[40:60]
        elif i == 2:
            train_files = data_dicts[0:20] + data_dicts[40:80]
            val_files = data_dicts[20:40]
        elif i == 3:
            train_files, val_files = data_dicts[20:80], data_dicts[0:20]
        ...
        train_transforms = Compose([
            ...
            Spacingd(keys=['image', 'label'], pixdim=(1.6, 1.6, 2.0), mode=('bilinear', 'nearest')),
            ...
            if (epoch + 1) % val_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    if metric > best_metric:
                        ...
                        torch.save(model.state_dict(), '/home/marafath/scratch/saved_models/zenodo_aug_{}.pth'.format(i+1))
