...
def main():
    ...
    print('Iran data: cropped and common resized, densenet+imhistnet-32bins-multigpu')
        ...
        if (epoch + 1) % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric > best_metric:
                    ...
                    torch.save(model.state_dict(), '/home/marafath/scratch/saved_models/best_model_densenet_imhistnet_mgpu.pth')
