...
def main():
    ...
    print('zenodo 4-fold cross-validation; epoch: 500 + initial 100')
    ...
    for i in range(0,4):
        ...
        model.load_state_dict(torch.load('/home/marafath/scratch/saved_models/zenodo_{}.pth'.format(i+1)))
            ...
            if (epoch + 1) % val_interval == 0:
                ...
                with torch.no_grad():
                    ...
                    if metric > best_metric:
                        ...
                        torch.save(model.state_dict(), '/home/marafath/scratch/saved_models/zenodo_v2_{}.pth'.format(i+1))
